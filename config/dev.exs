...
config :soup_and_nutz, SoupAndNutzWeb.Endpoint,
  ...
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:soup_and_nutz, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:soup_and_nutz, ~w(--watch)]}
  ]
...
config :soup_and_nutz, SoupAndNutzWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/soup_and_nutz_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :soup_and_nutz, dev_routes: true
